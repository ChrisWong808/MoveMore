...
module.exports = {
    getTrainer: function (trainer_id) {
        return db.query("SELECT * FROM trainers WHERE trainer_id='".concat(trainer_id, "'"))
    ...
    //   }
    // },
    createTrainer: function (trainer_id, account_id, location, tags, equipment, credentials, socials, bio) {
        return db.query('INSERT INTO trainers (trainer_id, account_id, location, tags, equipment, credentials, socials, bio) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [trainer_id, account_id, location, tags, equipment, credentials, socials, bio])
            .then(function (result) {
            return result;
        })
            .catch(function (err) {
    ...
    editTrainer: function (trainer_id, account_id, location, tags, equipment, credentials, socials, bio) {
        return db.query('UPDATE trainers SET location = $1, tags = $2, equipment = $3, credentials = $4, socials = $5, bio = $6 WHERE account_id = $7', [location, tags, equipment, credentials, socials, bio, account_id,])
            .then(function (result) {
            return result;
        })
            .catch(function (err) {
